 ...
 */
public abstract class BaseArtisanActivity extends ArtisanActivity {
    ...
    protected void initUI() {
        ...
        logoutResponseListener = new APIResponseListner() {
            ...
            public void onSuccess(CustomHttpResponse response) {
                ...
                Intent intent = new Intent(BaseArtisanActivity.this, LoginActivity.class);
            ...
            public void onFailure(CustomHttpResponse response) {
                ...
                UIUtility.showLongToast("logout fails", BaseArtisanActivity.this);
                Intent intent = new Intent(BaseArtisanActivity.this, LoginActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                sendLogoutBroadcast();
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menuSettings:
                ...
                startActivity(new Intent(BaseArtisanActivity.this, SettingsActivity.class));
                return true;
    ...
    public abstract BaseView getView(ArtisanActivity activity);

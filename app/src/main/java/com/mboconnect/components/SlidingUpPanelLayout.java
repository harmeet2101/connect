...
public class SlidingUpPanelLayout extends ViewGroup {
	 ...
	 */
	private static final float   DEFAULT_ANCHOR_POINT       = 1.0f;                                       // In
																										   // relative
																										   // %
...
//	private static final int     DEFAULT_FADE_COLOR         = 0x99000000;
	private static final int     DEFAULT_FADE_COLOR         = 00000000;

	/**
	 * Default Minimum velocity that will be detected as a fling
	 */
	private static final int     DEFAULT_MIN_FLING_VELOCITY = 400;                                        // dips
																										   // per
																										   // second
	/**
	...
	/**
	 * No-op stubs for
	 * {@link com.mboconnect.components.SlidingUpPanelLayout.PanelSlideListener}
	 * . If you only want to implement a subset of the listener methods you can
	 * extend this instead of implement the full interface.
	 */
	...
	public SlidingUpPanelLayout (Context context, AttributeSet attrs, int defStyle) {
		...
		if (mShadowHeight > 0) {
			if (mIsSlidingUp) {
				mShadowDrawable = getResources ().getDrawable (R.drawable.abc_ab_share_pack_mtrl_alpha);
			}
			else {
				mShadowDrawable = getResources ().getDrawable (R.drawable.abc_ab_share_pack_mtrl_alpha);
			}

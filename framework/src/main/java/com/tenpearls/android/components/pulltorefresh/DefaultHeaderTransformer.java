...
/**
 * The Class DefaultHeaderTransformer.
 */
public class DefaultHeaderTransformer extends PullToRefreshAttacher.HeaderTransformer {

	/** The m content layout. */
	private ViewGroup          mContentLayout;

	/** The m header text view. */
	private TextView           mHeaderTextView;

	/** The m header progress bar. */
	...
	/** The m use custom progress color. */
	private boolean            mUseCustomProgressColor = false;

	/** The m progress drawable color. */
	...
	/**
	 * Instantiates a new default header transformer.
	 */
	 ...
	 * HeaderTransformer#onViewCreated(android.app.Activity, android.view.View)
	 */
	@Override
	 ...
	 * @see
	 * com.tenpearls.android.components.pulltorefresh.PullToRefreshAttacher.
	 * HeaderTransformer#onPulled(float)
	 */
	@Override
	...
	public void onRefreshMinimized () {
		...
		if (mContentLayout != null) {
			mContentLayout.startAnimation (AnimationUtils.loadAnimation (mContentLayout.getContext (), R.anim.fade_out));
	 ...
	 * 
	 * @param enabled the new progress bar color enabled
	 */
	...
	/**
	 * Gets the action bar background.
	 * 
	 * @param context the context
	 * @return the action bar background
	 */
	...
	/**
	 * Gets the action bar title style.
	 * 
	 * @param context the context
	 * @return the action bar title style
	 */
